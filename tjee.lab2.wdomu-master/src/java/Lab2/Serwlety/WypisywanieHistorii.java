 ...
 * @author student
 */
@WebServlet(name = "WypisywanieHistorii", urlPatterns = {"/WypisywanieHistorii"})
public class WypisywanieHistorii extends HttpServlet {
    ...
    try {
        ...
        if (polaczenie) {
        data = Solution.DbManager.getHistoryData();
...
return data;
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<body>" + "Lista zmian " + "<br />");
