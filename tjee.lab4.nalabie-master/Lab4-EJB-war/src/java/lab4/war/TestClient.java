...
import lab4.ebj.SessionBeanRemote;
...
public class TestClient extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<b>Ostatni dostęp: " + sessionBean.getOstatnieDane()+ "</b><br/>");
            sessionBean.setOstatnieDane(request.getHeader("user-agent"), new java.util.Date());
            out.println("</body>");
            out.println("</html>");
        }
    }
